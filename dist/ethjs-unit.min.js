...
throw Error("[number-to-bn] while converting number "+JSON.stringify(t)+" to BN.js instance, error: invalid number value. Value must be an integer, hex string, BN or BigNumber instance. Note, decimals are not supported.")}},function(t,r,i){"use strict";function e(t){var r=n(t),i=m[r];if("string"!=typeof i)throw Error("[ethjs-unit] the unit provided "+t+" doesn't exists, please use the one of the following units "+JSON.stringify(m,null,2));return new u(i,10)}function n(t){return t?t.toLowerCase():"ether"}function o(t){if("string"==typeof t){if(!t.match(/^-?[0-9.]+$/))throw Error("while converting number to string, invalid number value '"+t+"', should be a number matching (^-?[0-9.]+).");return t}if("number"==typeof t)return t+"";if("object"==typeof t&&t.toString&&(t.toTwos||t.dividedToIntegerBy))return t.toPrecision?t.toPrecision()+"":t.toString(10);throw Error("while converting number to string, invalid number value '"+t+"' type "+typeof t+".")}function h(t,r,i){var o=a(t),h=o.lt(f),s=e(r),u=n(r);if("noether"===u)return"0";var p=m[u].length-1||1,c=i||{};h&&(o=o.mul(l));for(var d=o.mod(s).toString(10);p>d.length;)d="0"+d;c.pad||(d=d.match(/^([0-9]*[1-9]|0)(0*)/)[1]);var g=o.div(s).toString(10);c.commify&&(g=g.replace(/\B(?=(\d{3})+(?!\d))/g,","));var v=""+g+("0"==d?"":"."+d);return h&&(v="-"+v),v}function s(t,r){var i=o(t),h=e(r),s=n(r);if("noether"===s)return f;var a=m[s].length-1||1,p="-"===i.substring(0,1);if(p&&(i=i.substring(1)),"."===i)throw Error("[ethjs-unit] while converting number "+t+" to wei, invalid value");var c=i.split(".");if(c.length>2)throw Error("[ethjs-unit] while converting number "+t+" to wei,  too many decimal points");var d=c[0],g=c[1];if(d||(d="0"),g||(g="0"),g.length>a||"wei"===s&&!g.match(/^0+$/))throw Error("[ethjs-unit] while converting number "+t+" to wei, too many decimal places");for(;a>g.length;)g+="0";d=new u(d),g=new u(g);var v=d.mul(h).add(g);return p&&(v=v.mul(l)),new u(v.toString(10),10)}var u=i(0),a=i(2),f=new u(0),l=new u((-1)),m={noether:"0",wei:"1",kwei:"1000",Kwei:"1000",babbage:"1000",femtoether:"1000",mwei:"1000000",Mwei:"1000000",lovelace:"1000000",picoether:"1000000",gwei:"1000000000",Gwei:"1000000000",shannon:"1000000000",nanoether:"1000000000",nano:"1000000000",szabo:"1000000000000",microether:"1000000000000",micro:"1000000000000",finney:"1000000000000000",milliether:"1000000000000000",milli:"1000000000000000",ether:"1000000000000000000",kether:"1000000000000000000000",grand:"1000000000000000000000",mether:"1000000000000000000000000",gether:"1000000000000000000000000000",tether:"1000000000000000000000000000000"};t.exports={unitMap:m,numberToString:o,getValueOfUnit:e,fromWei:h,toWei:s}},function(t,r){"use strict";function i(t){var r=t.length;if(r%4>0)throw Error("Invalid string. Length must be a multiple of 4");var i=t.indexOf("=");i===-1&&(i=r);var e=i===r?0:4-i%4;return[i,e]}function e(t){var r=i(t),e=r[0],n=r[1];return 3*(e+n)/4-n}function n(t,r,i){return 3*(r+i)/4-i}function o(t){var r,e,o=i(t),h=o[0],s=o[1],u=new l(n(t,h,s)),a=0,m=s>0?h-4:h;for(e=0;m>e;e+=4)r=f[t.charCodeAt(e)]<<18|f[t.charCodeAt(e+1)]<<12|f[t.charCodeAt(e+2)]<<6|f[t.charCodeAt(e+3)],u[a++]=r>>16&255,u[a++]=r>>8&255,u[a++]=255&r;return 2===s&&(r=f[t.charCodeAt(e)]<<2|f[t.charCodeAt(e+1)]>>4,u[a++]=255&r),1===s&&(r=f[t.charCodeAt(e)]<<10|f[t.charCodeAt(e+1)]<<4|f[t.charCodeAt(e+2)]>>2,u[a++]=r>>8&255,u[a++]=255&r),u}function h(t){return a[t>>18&63]+a[t>>12&63]+a[t>>6&63]+a[63&t]}function s(t,r,i){for(var e,n=[],o=r;i>o;o+=3)e=(t[o]<<16&16711680)+(t[o+1]<<8&65280)+(255&t[o+2]),n.push(h(e));return n.join("")}function u(t){for(var r,i=t.length,e=i%3,n=[],o=16383,h=0,u=i-e;u>h;h+=o)n.push(s(t,h,h+o>u?u:h+o));return 1===e?(r=t[i-1],n.push(a[r>>2]+a[r<<4&63]+"==")):2===e&&(r=(t[i-2]<<8)+t[i-1],n.push(a[r>>10]+a[r>>4&63]+a[r<<2&63]+"=")),n.join("")}r.byteLength=e,r.toByteArray=o,r.fromByteArray=u;for(var a=[],f=[],l="undefined"!=typeof Uint8Array?Uint8Array:Array,m="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",p=0,c=m.length;c>p;++p)a[p]=m[p],f[m.charCodeAt(p)]=p;f["-".charCodeAt(0)]=62,f["_".charCodeAt(0)]=63},function(t,r){/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
